...
\begin{itemize}
    ...
    %registration process will be explained here
    ...
    \item \textbf{Home} \\
    When you log in in the application, straight way, you arrives on the home screen which fundamentally has everything what you need to use the application.
    ...
    Slide out menu has been utilized to give the application an extremely pleasant look in light of keeping the ease of use while exploring in the application. It has been shown in the fig 2.6.
   ...
   \item \textbf{Filter screens} \\
    Tapping on filter button on home screen takes you to this figure 2.7.
