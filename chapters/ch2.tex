...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.20\linewidth]{figures/ch2/app_icon_screen.png}
    ...
    By tapping on app icon on fig 2.1, it will lake you to landing screen of the app which is also called as main screen.
     ...
     This screen gives you two options, which are (as shown in fig 2.2) :
       ...
       \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/main_screen.png}
    ...
    \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/loginOptions.png}
    ...
    \end{figure}
     ...
     \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/login_email.png}
    ...
    \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/home.png}
    ...
    It has been shown in the fig 2.6.
     ...
     \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/side_menu_1.png}
   ...
   \item \textbf{Filter screens} \\
    ...
    \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/filter_screen.png}
    ...
    \begin{itemize}
        ...
        Year - Date wise click on filter screen takes you here, shown in fig 2.8.
         ...
         \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/year_list.png}
    ...
    \end{figure}
        ...
        Admin Level click takes you here, shown in fig 2.9.
         ...
         \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/level_list.png}
     ...
     Color scheme click takes you here, shown in fig 3.0.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/color_scheme.png}
