...
\begin{itemize}
    ...
    Figure 4.4 represents contact detail screen in which both the fields i.e Email and Phone are mandatory for record purpose and to avoid fake entries. User with unique email and phone can register only once. It's a good point to note that both the fields have been verified syntactically here.
...
\begin{itemize}
    ...
    \begin{figure}[!htb]
        ...
        \begin{minipage}{0.5\textwidth}
            ...
            \caption{Date list on selecting year}\label{Fig:date_list_ch4}
        \end{minipage}
    \end{figure}
