...
\begin{itemize}
    ...
    \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/register_personal.png}
    ...
    \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/register_contact.png}
    ...
    \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/register_location.png}
    ...
    \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/credentials_setup.png}
    ...
    \item Purpose of using the app
     ...
     \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/purpose_app.png}
...
Figure 4.16 shows the sliding menu and the options it includes.
    ...
    \begin{figure}[H]
            \centering
            \includegraphics[width=0.25\linewidth]{figures/ch2/side_menu.png}
