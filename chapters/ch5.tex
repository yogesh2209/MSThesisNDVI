...
where $A$ is $m$ x $n$ real matrix with $m>n$, $U$ as $m$ x $m$ and $V$ as an $n$ x $n$. Figure~\ref{fig:svd_matrix} shows visualisation of the matrix multiplications in \gls{svd}.
