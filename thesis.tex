...
%Yogesh Kohli's included packages
...
% 
\title{Development of EyesOnCrops: \\
...
% 
\titleheading{Development of EyesOnCrops: \\
A new iOS app to visualize the NASA NDVI data}
...
\committeecochair{Samuel Shen}
\committeecochairdept{Department of Mathematics \& Statistics}

%\committeeseconddept{Department of Mathematics & Statistics}

% Third (usually different department) committee member
\committeesecond{Roger Whitney}
\committeeseconddept{Department of Computer Science}

% Third (usually different department) committee member
\committeethird{Ming-Hsiang Tsou}
\committeethirddept{Department of Geography}
...
\begin{dedication}
  \vspace{3in}
  \centering
  Dedicated to my parents, brother, sister-in-law, and my nephew, Prihaan.
\end{dedication}
...
I would like to thank my thesis Chair, Dr. Carl Eckberg, Professor of Computer Science department and Co-Chair, Dr. Samuel Shen, Professor of Mathematics and Statistics department. The way to Prof Eckberg's and Dr. Shen's office was constantly open at whatever point I kept running into an inconvenience spot or had an inquiry concerning my research or writing. I might likewise want to thank Alan Bassist for this constant expert advices and suggestions throughout this great adventure. Without his energetic interest and information, the approval review couldn't have been effectively led. I would also like to thank Jeremy King of the Eyes on Earth team for his exceptionally significant support on server side and the backend system.
\end{acknowledgments}
%
