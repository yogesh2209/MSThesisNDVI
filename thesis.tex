...
% 
\title{Development of the EyesOnCrops: A new iOS app to visualize the NASA NDVI data}
...
% 
\titleheading{Mathematical applications \\
...
% Your committee co-chair (don't include titles as per the manual)
\committeecochair{Sam Shen}
\committeecochairdept{Department of Mathematics and Statistics}

% Second committee member
\committeesecond{Dr. Roger Whitney}
